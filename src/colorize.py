...
def apply_color_filter(image, style):
    ...
    if style == "modern":
        ...
        img_array = img_array * np.array([1.0, 0.95, 0.9])
        img_array += np.array([0.05, 0.03, 0.0])
...
def main():
    ...
    try:
        ...
        print("Model weights not found. Output will be random. Train the model (see TRAINING.md).")
